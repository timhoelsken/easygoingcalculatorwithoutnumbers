...
public class StringConvertTest extends TestCase {
	...
	public void testRequirements() throws Exception {
		...
		assertTrue("The String is converted correctly", !tmpErrorOccured && "(3*x+5)*15".equals(tmpConvertedString));
		...
		assertTrue("The String is converted correctly", !tmpErrorOccured && "x^2+2*x*y+y^2".equals(tmpConvertedString));
		...
		assertTrue("The String is converted correctly", !tmpErrorOccured && "c*~(x)+s*%(&(2)-x)".equals(tmpConvertedString));
	}
	...
	public void testTermToStandardString1() throws Exception {
		...
		assertTrue("The String has Variables separated by *", ConverterUtil.termToStandardString(tmpString).equals("2*a+a*b"));
	}
	...
	public void testTermToStandardString2() throws Exception {
		...
		assertTrue("The String is converted correctly", !tmpErrorOccured && "3*%(4+5)-(-3)".equals(tmpConvertedString));
	}
	...
	public void testTermToStandardString4() throws Exception {
		...
		assertTrue("The String is converted correctly", !tmpErrorOccured && "a*b*c*o*s*%(~((-3)))".equals(tmpConvertedString));
	}
	...
	public void testCleanVariables() {
		...
		assertTrue("The String has Variables separated by *", ConverterUtil.insertMultiplicationOperators(tmpString).equals("2*a+a*b"));
	}
	...
	public void testSetBracketsAroundNegativeNumbers1() {
		...
		String tmpString = ConverterUtil.setBracketsAroundNegatives("-8+(-23.23434+(-34))*(-5)+(-23^3)+(-1*(-2*(-5)))))+(-a+b)");
